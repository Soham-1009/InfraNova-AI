...
10. **Final Model Selection & Promotion**: Exp9 Epoch 46 checkpoint has been formally promoted to the active production model ([`outputs/best/pix2pix_landsat_best.pth`](outputs/best/pix2pix_landsat_best.pth), SHA-256: `71bbda3f31b85e7e741b26d5ce0ff398a0394c7dd4ef6ff5452f31f7e0400382`). The previous baseline has been preserved with full rollback metadata.
...
| :--- | :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| **Legacy Prod** | Legacy Baseline (Backup) | Custom U-Net (21.38M) | BCE, $\lambda_{\text{perc}}=10, \lambda_{\text{chroma}}=2$ | Val SSIM: 0.2522 | 11.7138 | 0.3254 | 0.2144 | 0.2752 | 12.53° | 27.2355 | 1.1993 (+0.199) | 0.3572 | 0.2992 | 0.2835 | Archived Baseline | Previous serving model; preserved for reference. |
...
| **Exp9** | **Global ResNet Generator** | **Global ResNet (11.37M)** | **LSGAN, $\lambda_{\text{sat}}=0.05$ (Exp7 config)** | **Val SSIM: 0.3802 (Ep 46)** | **13.7447** | **0.4502** | **0.1723** | **0.2217** | **11.28°** | **22.5706** | **0.9340 (-0.066)** | **0.4607** | **0.3711** | **0.3643** | **Active Production** | **Decisive breakthrough across all primary metrics.** |
...
## 3. Detailed Profile: Exp9 Production Model vs Legacy Baseline
...
| Metric | Legacy Baseline | Exp9 (Active Production) | Absolute Delta | Relative Improvement |
| :--- | :---: | :---: | :---: | :---: |
...
- **Histogram Distance**: Legacy Baseline achieved `0.3572`, whereas Exp9 achieved `0.4607` (+0.1035).
- **Analysis**: Legacy baseline biased predictions toward global mean channel distributions at the expense of high-frequency spatial edge definition and object sharpness. Exp9 produces sharper contrast and higher local variation, which slightly broadens the global histogram distance while drastically boosting structural SSIM (+38.3%) and downstream object detection accuracy (+24.0%). This trade-off is accepted.
...
| :--- | :--- | :--- | :--- |
| **Active Production (Exp9)** | `outputs/best/pix2pix_landsat_best.pth` | `71bbda3f31b85e7e741b26d5ce0ff398a0394c7dd4ef6ff5452f31f7e0400382` | Active Serving Model |
| **Archived Baseline Backup** | `outputs/best/pix2pix_landsat_backup_20260912_231938.pth` | `4604d36d07a0fb4c0696a53040c17004084068c51cc745a23f69b76c8baf6aa8` | Protected Baseline Backup |
| **Historical Exp9 Source** | `outputs/exp9/best/pix2pix_landsat_best.pth` | `71bbda3f31b85e7e741b26d5ce0ff398a0394c7dd4ef6ff5452f31f7e0400382` | Original Source Checkpoint |
...
| **Rollback Ledger** | `outputs/best/rollback_metadata.json` | — | Verified Promotion Ledger |
